...
const DatePickerInput = (props: DatePickerPrimitive.InputProps) => {
  ...
  return (
    <DatePickerPrimitive.Input
      class={cn(
        "h-9 w-full rounded-md border border-border bg-background px-3 py-1 text-sm shadow-sm transition-shadow placeholder:text-muted-foreground focus-visible:ring-[1.5px] focus-visible:ring-ring focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        local.class,
      )}
      {...others}
    />
...
const DatePickerTrigger = (props: DatePickerPrimitive.TriggerProps) => {
  ...
  return (
    <DatePickerPrimitive.Trigger
      class={cn(
        "flex min-h-9 min-w-9 items-center justify-center rounded-md border border-border bg-background transition-[box-shadow,background-color] hover:bg-accent/50 focus-visible:ring-[1.5px] focus-visible:ring-ring focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>svg]:size-4",
        local.class,
      )}
      {...others}
    >
...
const DatePickerContent = (props: DatePickerPrimitive.ContentProps) => {
  ...
  return (
    <DatePickerPrimitive.Content
      class={cn(
        "z-50 rounded-md border bg-popover p-3 text-popover-foreground shadow-md outline-none data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95",
        local.class,
      )}
      {...others}
    >
...
const DatePickerTableCell = (props: DatePickerPrimitive.TableCellProps) => {
  ...
  return (
    <DatePickerPrimitive.TableCell
      class={cn(
        "flex-1 p-0 text-center text-sm has-[[data-in-range]]:bg-accent has-[[data-in-range]]:first-of-type:rounded-l-md has-[[data-in-range]]:last-of-type:rounded-r-md has-[[data-outside-range][data-in-range]]:bg-accent/50 has-[[data-range-end]]:rounded-r-md has-[[data-range-start]]:rounded-l-md",
        local.class,
      )}
      {...others}
    />
